...
let package = Package(
	...
	dependencies: [
		.package(url: "https://github.com/AzureAD/microsoft-authentication-library-for-objc.git", .upToNextMinor(from: "2.15.0")),
		...
		.package(url: "https://github.com/google/google-api-objectivec-client-for-rest.git", .upToNextMinor(from: "5.4.0")),
		...
		.package(url: "https://github.com/google/promises.git", .upToNextMinor(from: "2.4.1")),
		.package(url: "https://github.com/groue/GRDB.swift.git", .upToNextMinor(from: "7.11.1")),
		.package(url: "https://github.com/openid/AppAuth-iOS.git", .upToNextMinor(from: "2.1.0")),
